...
using UniversityHelper.UniversityService.Broker.Consumers;
...
using UniversityHelper.UniversityService.Models.Dto.Requests.User;
using UniversityHelper.UniversityService.Validation.User;
using MassTransit;
...
using UniversityHelper.UniversityService.Validation.User.Interfaces;
...
namespace UniversityHelper.UniversityService
{
    public class Startup : BaseApiInfo
    {
        ...
        public Startup(IConfiguration configuration)
        {
            ...
            Version = "2.0.2.0";
            Description = "UniversityService is an API that intended to work with notes.";
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<UniversityServiceDbContext>(options =>
            {
